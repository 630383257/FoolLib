namespace Fool.Files {
    ...
    public struct FileSize {
        ...
        public double GetSizeByK() {
            return Fool.Helpers.Convert.ToDouble( _size / 1024.0, 2 );
        }
        ...
        public double GetSizeByM() {
            return Fool.Helpers.Convert.ToDouble( _size / 1024.0 / 1024.0, 2 );
        }
        ...
        public double GetSizeByG() {
            return Fool.Helpers.Convert.ToDouble( _size / 1024.0 / 1024.0 / 1024.0, 2 );
        }
